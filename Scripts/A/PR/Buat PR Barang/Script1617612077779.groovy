...
//WebUI.click(findTestObject('PR/Buat PR/a_Purchase Request'))
WebUI.click(findTestObject('PR/Buat PR/a_Buat PR'))
...
WebUI.scrollToElement(findTestObject('PR/Buat PR/div_barang2'), 3)

WebUI.setText(findTestObject('PR/Buat PR/Spesifiksi'), 'Spesifikasi : bagus, murah ')

WebUI.click(findTestObject('PR/Buat PR/button_Proses'))
